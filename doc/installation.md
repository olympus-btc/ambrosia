...
```bash
curl -fsSL https://raw.githubusercontent.com/olympus-btc/ambrosia/refs/tags/v0.8.0-beta/scripts/install.sh | bash -s -- --yes
```

*Automatic installation (without systemd services):*
```bash
curl -fsSL https://raw.githubusercontent.com/olympus-btc/ambrosia/refs/tags/v0.8.0-beta/scripts/install.sh | bash -s -- --yes --no-service
```
...
```bash
wget -q https://raw.githubusercontent.com/olympus-btc/ambrosia/refs/tags/v0.8.0-beta/scripts/install.sh
chmod +x install.sh
```
