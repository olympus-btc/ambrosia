...
class TestProductsPermissions:
    ...
    async def test_products_read_required_for_get_variants(self, client_factory):
        ...
        await assert_permission_gate(client_factory, "get", f"/products/{DUMMY_ID}/variants", "products_read")
    ...
    async def test_products_read_required_for_get_options(self, client_factory):
        ...
        await assert_permission_gate(client_factory, "get", f"/products/{DUMMY_ID}/options", "products_read")
    ...
    async def test_products_update_required_for_post_variant(self, client_factory):
        ...
        await assert_permission_gate(client_factory, "post", f"/products/{DUMMY_ID}/variants", "products_update", body={})
    ...
    async def test_products_update_required_for_put_variant(self, client_factory):
        ...
        await assert_permission_gate(client_factory, "put", f"/products/{DUMMY_ID}/variants/{DUMMY_ID}", "products_update", body={})
        logger.info("✓ products_update correctly gates PUT /products/{id}/variants/{variantId}")
    ...
    async def test_products_update_required_for_delete_variant(self, client_factory):
        ...
        await assert_permission_gate(client_factory, "delete", f"/products/{DUMMY_ID}/variants/{DUMMY_ID}", "products_update")
        logger.info("✓ products_update correctly gates DELETE /products/{id}/variants/{variantId}")
    ...
    async def test_products_update_required_for_post_option(self, client_factory):
        ...
        await assert_permission_gate(client_factory, "post", f"/products/{DUMMY_ID}/options", "products_update", body={})
    ...
    async def test_products_update_required_for_put_option(self, client_factory):
        ...
        await assert_permission_gate(client_factory, "put", f"/products/{DUMMY_ID}/options/{DUMMY_ID}", "products_update", body={})
        logger.info("✓ products_update correctly gates PUT /products/{id}/options/{optionTypeId}")
    ...
    async def test_products_update_required_for_delete_option(self, client_factory):
        ...
        await assert_permission_gate(client_factory, "delete", f"/products/{DUMMY_ID}/options/{DUMMY_ID}", "products_update")
        logger.info("✓ products_update correctly gates DELETE /products/{id}/options/{optionTypeId}")
