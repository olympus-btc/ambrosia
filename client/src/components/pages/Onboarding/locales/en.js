const onboardingEn = {
  ...
  stepWallet: {
    ...
    subtitle: "Choose how you'll receive Lightning payments",
    phoenixdDescription: "Self-hosted node. Requires phoenixd running on this server.",
  ...
  restore: {
    ...
    subtitle: "Upload a backup file exported from another Ambrosia installation to restore your business data.",
    submitButton: "Restore backup",
    submitting: "Restoring...",
    restoring: "Restoring your backup...",
    phaseUploading: "Uploading your backup...",
