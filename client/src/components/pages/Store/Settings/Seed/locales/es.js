const seedEs = {
  cardSeed: {
    ...
    secretsLockedError: "El cifrado de secretos está bloqueado. Desbloquéalo en Configuración → Cifrado de secretos para ver tu SEED.",
    notAvailableNwc: "La exportación de la seed no está disponible al usar un backend Nostr Wallet Connect (NWC).",
  },
};

export default seedEs;
