const componentsEs = {
  ...
  shifts: {
    ...
    closeShiftSuccess: "Turno cerrado exitosamente",
    closeShiftError: "Error al cerrar el turno",
    other: "Otro",
